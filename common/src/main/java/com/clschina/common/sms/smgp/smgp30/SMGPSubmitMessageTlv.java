...
public class SMGPSubmitMessageTlv extends SMGPMessage {
	...
	public SMGPSubmitMessageTlv(String src_terminal_id, String dest_terminal_id, String msg_content, String service_id,
			String spid) throws UnsupportedEncodingException {
