 ...
 * 
 */
public class SMGPMessageDecoder implements ProtocolDecoder {
	private static Log log = LogFactory.getLog(SMGPMessageDecoder.class);
	...
	public void decode(IoSession session, IoBuffer in, ProtocolDecoderOutput out) throws Exception {
		try {
			SMGPMessage message = SMGPMessage.read(in.asInputStream());
			out.write(message);
		} catch (Exception e) {
