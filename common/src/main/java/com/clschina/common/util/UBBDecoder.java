...
public class UBBDecoder {
	private final static Log log = LogFactory.getLog(UBBDecoder.class);
    ...
    public static final String decode(String s){
    	return decode(s, new SimpleTagHandler(), MODE_IGNORE, false);
    }
    public static final String decode(String s, UBBTagHandler th){
    	return decode(s, th, MODE_IGNORE, false);
    }
    /**
     * 进行UBB标签的转换
